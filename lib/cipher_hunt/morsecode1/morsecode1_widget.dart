    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: Visibility(
            visible: FFAppState().curentQuestion == 1,
            child: Stack(
              children: [
                Align(
                        ...
                        children: [
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MORSECODE1_PAGE_FOOD_BTN_ON_TAP');
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MORSECODE1_PAGE_MOOD_BTN_ON_TAP');
                                logFirebaseEvent('Button_alert_dialog');
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MORSECODE1_PAGE_LOOP_BTN_ON_TAP');
                                logFirebaseEvent('Button_alert_dialog');
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
